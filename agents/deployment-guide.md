...
meta:
  ...
  description: |
    ...
    **MUST be used for:**
    ...
    assistant: "I'll use deployment-guide for CI/CD setup — it knows the push-to-deploy workflow shape and the repo secrets/variables `cicd create` sets."
    <commentary>
    CI/CD setup covers the GitHub-OIDC push-to-deploy workflow shape and the repo variables/secrets
    generated by `amplifier-online cicd create`. deployment-guide owns cicd-guide.md.
    </commentary>
    </example>
